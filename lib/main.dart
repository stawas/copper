...
void main() async {
  ...
  // var id = RandomHelper.getUniqueId();
  // var noteOne = Note(
  //     id: id,
  //     name: "name3",
  //     content: "note number 3",
  //     updateDate: DateTime.now().millisecondsSinceEpoch);

  // noteBox.put(id, noteOne);

  final note = noteBox.values;
  var noteLength = note.length;
  for (var i = 0; i < noteLength; i++) {
    print(await note.elementAt(i).updateDate.toReadableDate());
  }
