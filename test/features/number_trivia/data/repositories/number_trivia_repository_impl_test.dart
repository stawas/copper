...
@GenerateMocks([], customMocks: [
  MockSpec<NumberTriviaRemoteDataSource>(as: #MockNumberTriviaRemoteDatasource)
])
@GenerateMocks([], customMocks: [
  MockSpec<NumberTriviaLocalDataSource>(as: #MockNumberTriviaLocalDataSource)
])
@GenerateMocks([], customMocks: [MockSpec<NetworkInfo>(as: #MockNetworkInfo)])
void main() {
